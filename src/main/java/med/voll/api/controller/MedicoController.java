...
public class  MedicoController {
    ...
    public ResponseEntity atualizar(@RequestBody @Valid DadosAtualizacaoMedico dados) {
        ...
        return ResponseEntity.ok(new DadosDetalhamentoMedico(medico)); // Adiciona um retorno de resposta 200 (OK)
    }
    ...
    @DeleteMapping("/{id}")
        @Transactional
        public ResponseEntity<Object> exluir(@PathVariable Long id){
